...
Процедура ПриОбновленииСоставаПользовательскихНастроекНаСервере(СтандартнаяОбработка)
	...
	ПараметрыОбновления = Новый Структура("ИмяСобытия", "ПриОбновленииСоставаПользовательскихНастроекНаСервере");
  	//++ЭЛИАС 20170426 
	Если Параметры.Свойство("СброситьПользовательскиеНастройки") Тогда
		ПараметрыОбновления.Вставить("СброситьПользовательскиеНастройки", Параметры.СброситьПользовательскиеНастройки);
	КонецЕсли;
	//--ЭЛИАС 20170426

...
Функция СписокТиповПоНазначениюИспользования(КлючНазначенияИспользования) Экспорт
	...
	Если КлючНазначенияИспользования = "ДокументыПокупателей"
	 Или КлючНазначенияИспользования = "ДокументыКонтрагентов" Тогда
		...
		//++ЭЛИАС 20170411
		СписокДокументов.Добавить(Тип("ДокументСсылка.АР_НачислениеАренднойПлаты")); 
		СписокДокументов.Добавить(Тип("ДокументСсылка.АР_НачислениеПени")); 
		СписокДокументов.Добавить(Тип("ДокументСсылка.АР_СчетНаАренду")); 
		//--ЭЛИАС 20170411

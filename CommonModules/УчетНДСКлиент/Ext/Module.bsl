...
//++ЭЛИАС 20131003  
Функция ВыполнитьКомандуПечатиСчетовФактурСводных(ОписаниеКоманды) Экспорт
...
КонецФункции //--ЭЛИАС 20131003

//++ЭЛИАС 20171016 
Функция ВыполнитьКомандуПечатиУниверсальныхПередаточныхДокументовСводных(ОписаниеКоманды) Экспорт
	...
	Если ОписаниеКоманды.Свойство("ДополнительныеПараметры")
		...
		ПараметрыПечати.Вставить("ДополнительныеПараметры", ОписаниеКоманды.ДополнительныеПараметры);
		//++ЭЛИАС 20171016 
		ПараметрыПечати.ДополнительныеПараметры.Вставить("СчетФактураСводный");
		//--ЭЛИАС 20171016
	КонецЕсли; 

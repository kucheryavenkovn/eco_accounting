...
Процедура ПереносКИПриОбновленииС20()
	...
	//++ЭЛИАС 20120712
	// Справочник "Объекты аренды"
	СоответствиеВидовКИ.Вставить(Справочники.УдалитьВидыКонтактнойИнформации.АдресОбъектаАренды, Справочники.ВидыКонтактнойИнформации.АдресОбъектаАренды);
	//--ЭЛИАС 20120712
	...
	//++ЭЛИАС 20120712
	СоответствиеГруппВидовКИ.Вставить(Тип("СправочникСсылка.АР_ОбъектыАренды")        , Справочники.ВидыКонтактнойИнформации.СправочникАР_ОбъектыАренды);
	//--ЭЛИАС 20120712
...
Процедура ПереносДопСвойствПриОбновленииС20()
	...
	СоответствиеТипов.Вставить(Тип("СправочникСсылка.АР_ОбъектыАренды")              ,"СправочникСсылка.АР_ОбъектыАренды"); //++ЭЛИАС 20120625

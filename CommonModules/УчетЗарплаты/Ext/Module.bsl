...
Функция РолиРедактированияДанных() Экспорт
	...
	Роли.Добавить("ОбработкаЗаявокКабинетСотрудника");
...
Процедура УправлениеДоступностьюКадровыхРеквизитов(Форма, ДоступностьКадровыхРеквизитов) Экспорт
...
Процедура НастроитьПорядокЗаполненияСТДР() Экспорт

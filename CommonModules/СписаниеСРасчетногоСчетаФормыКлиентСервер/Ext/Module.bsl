...
Функция ТекущиеДанныеРасшифровкаПлатежа(Форма, ИдСтроки = -1) Экспорт
	...
	Если ФормаДокументаОднострочная(Форма) Тогда
		...
		//++ЭЛИАС 20150520  
		Результат.Вставить("АР_ПериодАренды", 				 Форма.РасшифровкаПлатежаАР_ПериодАренды);
		Результат.Вставить("АР_СчетНаАренду", 				 Форма.РасшифровкаПлатежаАР_СчетНаАренду);
		Результат.Вставить("АР_УслугаАренды", 				 Форма.РасшифровкаПлатежаАР_УслугаАренды);
		Результат.Вставить("АР_ОбъектАренды", 				 Форма.РасшифровкаПлатежаАР_ОбъектАренды);
		Результат.Вставить("АР_Депозит", 					 Форма.РасшифровкаПлатежаАР_Депозит);
		Результат.Вставить("АР_Пени", 						 Форма.РасшифровкаПлатежаАР_Пени);
		//--ЭЛИАС 20150520
...
Процедура ЗаполнитьЗначенияТекущиеДанныеРасшифровкаПлатежа(Форма, НовыеДанныеСтроки, ИдСтроки = -1, ЗаполнятьСуммуДокумента = Истина) Экспорт
	...
	Если ФормаДокументаОднострочная(Форма) Тогда
		...
		//++ЭЛИАС 20150519  
		Форма.РасшифровкаПлатежаАР_ПериодАренды 			   = НовыеДанныеСтроки.АР_ПериодАренды;
		Форма.РасшифровкаПлатежаАР_СчетНаАренду 			   = НовыеДанныеСтроки.АР_СчетНаАренду;
		Форма.РасшифровкаПлатежаАР_УслугаАренды 			   = НовыеДанныеСтроки.АР_УслугаАренды;
		Форма.РасшифровкаПлатежаАР_ОбъектАренды 			   = НовыеДанныеСтроки.АР_ОбъектАренды;
		Форма.РасшифровкаПлатежаАР_Депозит 					   = НовыеДанныеСтроки.АР_Депозит;
		Форма.РасшифровкаПлатежаАР_Пени 					   = НовыеДанныеСтроки.АР_Пени;
		//--ЭЛИАС 20150519
...
Процедура ЗаполнитьРасшифровкаПлатежаИзРеквизитовФормы(Форма) Экспорт
	...
	//++ЭЛИАС 20150519  
	СтрокаПлатеж.АР_ПериодАренды				= Форма.РасшифровкаПлатежаАР_ПериодАренды;
	СтрокаПлатеж.АР_СчетНаАренду				= Форма.РасшифровкаПлатежаАР_СчетНаАренду;
	СтрокаПлатеж.АР_УслугаАренды				= Форма.РасшифровкаПлатежаАР_УслугаАренды;
	СтрокаПлатеж.АР_ОбъектАренды				= Форма.РасшифровкаПлатежаАР_ОбъектАренды;
	СтрокаПлатеж.АР_Депозит						= Форма.РасшифровкаПлатежаАР_Депозит;
	СтрокаПлатеж.АР_Пени						= Форма.РасшифровкаПлатежаАР_Пени;
	//--ЭЛИАС 20150519

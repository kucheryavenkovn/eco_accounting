...
Функция ПолучитьОписаниеАктаОбОказанииУслуг() Экспорт
	...
	//++ЭЛИАС 20180904 
	ТипДокументы.Добавить(Тип("ДокументСсылка.АР_НачислениеАренднойПлаты"));
	ТипДокументы.Добавить(Тип("ДокументСсылка.АР_НачислениеПени"));
	//--ЭЛИАС 20180904
	...
	//++ЭЛИАС 20180904 
	Таблица.Колонки.Добавить("НачалоПериода",           	ОписаниеДаты);
	Таблица.Колонки.Добавить("ОкончаниеПериода",           	ОписаниеДаты);
	//--ЭЛИАС 20180904
...
Функция ПолучитьОписаниеТаблицыАктаОбОказанииУслуг() Экспорт
	...
	Таблица.Колонки.Добавить("СуммаСНДС",					ОписаниеТиповЧисло15_2);
	//++ЭЛИАС 20180904 
	Таблица.Колонки.Добавить("СпособНачисления",           	Новый ОписаниеТипов("СправочникСсылка.АР_СпособыНачисленияАренднойПлаты"));
	Таблица.Колонки.Добавить("СтавкаСпособаНачисления",    	ОписаниеТиповЧисло15_2);
	Таблица.Колонки.Добавить("КоличествоДней",           	ОбщегоНазначения.ОписаниеТипаЧисло(10, 0));
	//--ЭЛИАС 20180904

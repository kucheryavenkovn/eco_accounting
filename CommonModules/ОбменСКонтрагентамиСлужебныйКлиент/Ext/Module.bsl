...
Процедура ОткрытьСопоставлениеНоменклатуры(Знач НоменклатураКонтрагентов, Знач Настройки = Неопределено, Знач ОповещениеОЗакрытии = Неопределено) Экспорт
	...
	Если ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.ПодсистемаСопоставленияНоменклатурыСуществует() Тогда
		ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.МодульСопоставлениеНоменклатурыКонтрагентовСлужебныйКлиент().ОткрытьСопоставлениеНоменклатуры(
...
Процедура ОткрытьВыборНоменклатурыКонтрагента(Знач ВладелецНоменклатуры, Знач ВладелецФормы, Знач Идентификатор = Неопределено) Экспорт
	...
	Если ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.ПодсистемаСопоставленияНоменклатурыСуществует() Тогда
		ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.МодульСопоставлениеНоменклатурыКонтрагентовСлужебныйКлиент().ОткрытьВыборНоменклатурыКонтрагента(
...
Процедура ОткрытьФормуНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность, Знач ОповещениеОЗакрытии) Экспорт
	...
	Если ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.ПодсистемаСопоставленияНоменклатурыСуществует() Тогда
		ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.МодульСопоставлениеНоменклатурыКонтрагентовСлужебныйКлиент().ОткрытьФормуНоменклатуры(
...
Процедура ОткрытьФормуВыбораНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность) Экспорт
	...
	Если ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.ПодсистемаСопоставленияНоменклатурыСуществует() Тогда
		ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.МодульСопоставлениеНоменклатурыКонтрагентовСлужебныйКлиент().ОткрытьФормуВыбораНоменклатуры(
...
Процедура ОткрытьСписокНоменклатурыКонтрагентов() Экспорт
	...
	Если ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.ПодсистемаСопоставленияНоменклатурыСуществует() Тогда
		ОбменСКонтрагентамиСлужебныйКлиентПовтИсп.МодульСопоставлениеНоменклатурыКонтрагентовСлужебныйКлиент().ОткрытьСписокНоменклатурыКонтрагентов();
		Возврат;
	КонецЕсли;

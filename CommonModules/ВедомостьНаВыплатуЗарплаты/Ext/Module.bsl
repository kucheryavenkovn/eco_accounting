...
Процедура СоздатьВТЗарплатаКВыплате(
	...
	КонецЕсли;
	Если ОписаниеОперации.ВидДохода = Перечисления.ВидыДоходовИсполнительногоПроизводства.ЗарплатаВознаграждения Тогда 
		ПараметрыПолученияЗарплатыКВыплате.ВидыДоходов.Добавить(Перечисления.ВидыДоходовИсполнительногоПроизводства.ЗарплатаВознаграждения);
		ПараметрыПолученияЗарплатыКВыплате.ВидыДоходов.Добавить(Перечисления.ВидыДоходовИсполнительногоПроизводства.ПустаяСсылка());
	...
	Иначе
		ПараметрыПолученияЗарплатыКВыплате.ВидыДоходов = ОбщегоНазначенияБЗК.ПеречислениеВМассив(Перечисления.ВидыДоходовИсполнительногоПроизводства);
		ПараметрыПолученияЗарплатыКВыплате.ВидыДоходов.Добавить(Перечисления.ВидыДоходовИсполнительногоПроизводства.ПустаяСсылка());
	КонецЕсли;	
...
Процедура ОчиститьВидыДоходовИсполнительногоПроизводстваЗарплаты(МетаданныеВедомости, ПараметрыОбновления) Экспорт
	...
	Пока ВыборкаОбновляемыхДанных.Следующий() Цикл
		...
		УчетНачисленнойЗарплаты.ОчиститьВидыДоходовИсполнительногоПроизводстваНабораЗаписей(Ведомость.Зарплата, "ПериодВзаиморасчетов");

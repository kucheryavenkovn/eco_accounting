...
Процедура ЗаполнитьРеквизитыРасшифровкаПлатежа(Форма, ЗаполнитьРеквизитыФормы = Ложь, СтрокаПлатежа = Неопределено) Экспорт
	...
	//++ЭЛИАС 20180202 
	РеквизитыРасшифровкиАренды = Новый Массив;
	РеквизитыРасшифровкиАренды.Добавить("АР_ПериодАренды");
	РеквизитыРасшифровкиАренды.Добавить("АР_СчетНаАренду");
	РеквизитыРасшифровкиАренды.Добавить("АР_УслугаАренды");
	РеквизитыРасшифровкиАренды.Добавить("АР_ОбъектАренды");
	РеквизитыРасшифровкиАренды.Добавить("АР_Депозит");
	РеквизитыРасшифровкиАренды.Добавить("АР_Пени");
	РеквизитыРасшифровкиАренды.Добавить("АР_СчетПеней");
	//--ЭЛИАС 20180202
...
Функция ДанныеРасшифровкиПлатежаОднострочнойФормы(Форма) Экспорт
	...
	Результат.Вставить("АР_СчетПеней", 					Форма.РасшифровкаПлатежаАР_СчетПеней);
	//--ЭЛИАС 20150520

...
Процедура ТекстНеобходимоЗаполнитьПатентОбработкаНавигационнойСсылки(ВладелецФормы, НавигационнаяСсылка, Организация, Дата, СтандартнаяОбработка) Экспорт
	
	Если НавигационнаяСсылка = УчетПСНКлиентСервер.НавигационнаяСсылкаНеобходимоЗаполнитьПатент() Тогда
		
		ОткрытьФормуСозданияНовогоПатента(ВладелецФормы, Организация, Дата, СтандартнаяОбработка);
...
Процедура ОткрытьФормуСозданияНовогоПатента(ВладелецФормы, Организация, Дата, СтандартнаяОбработка)

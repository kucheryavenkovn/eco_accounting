...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//Дудник
	СписокОбъектов.Добавить(Документы.ЭКО_ОперацииСКонтейнерами);	
	//Кучерявенко
	СписокОбъектов.Добавить(Документы.Претензия);	
	...
	//++ЭЛИАС 20150915  
	АР_ОбщиеПроцедуры.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	//--ЭЛИАС 20150915

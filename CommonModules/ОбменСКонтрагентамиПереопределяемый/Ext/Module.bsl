...
Процедура ПодготовитьСтруктуруОбъектовКомандЭДО(СоставКомандЭДО) Экспорт
	...
	//++ЭЛИАС 20160615 
	СоставКомандЭДО.Исходящие.Добавить("Документ.АР_СчетНаАренду");
	СоставКомандЭДО.Исходящие.Добавить("Документ.АР_НачислениеАренднойПлаты");
	СоставКомандЭДО.Исходящие.Добавить("Документ.АР_НачислениеПени");
	
	СоставКомандЭДО.БезПодписи.Добавить("Документ.АР_СчетНаАренду");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.АР_НачислениеАренднойПлаты");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.АР_НачислениеПени");
	//--ЭЛИАС 20160615
...
Процедура НазначенСтатусПодписан(ЭлектронныйДокумент) Экспорт
	ОбменСКонтрагентамиБП.НазначенСтатусПодписан(ЭлектронныйДокумент);
КонецПроцедуры

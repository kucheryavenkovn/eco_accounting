...
Процедура ЗаполнитьНаСервере()
	...
	РезультатыОтраженияЗарплаты.Вставить("ВыплатаОтпусковЗаСчетРезерва", ОтражениеЗарплатыВБухучете.НоваяТаблицаНачисленныеОтпуска());
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОценочныеОбязательстваЗарплатаКадры") Тогда
		...
		Если НастройкиРезервовОтпусков.ФормироватьРезервОтпусковБУ Тогда
			...
			ПараметрыДляСписанияРасходов.НачисленныеОтпуска 		= РезультатыОтраженияЗарплаты.ВыплатаОтпусковЗаСчетРезерва;
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(РезультатыОтраженияЗарплаты.ВыплатаОтпусковЗаСчетРезерва, Объект.ВыплатаОтпусковЗаСчетРезерва);

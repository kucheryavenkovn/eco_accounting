...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры, "СуммаДокумента, Организация, ЭтоВозврат, ЭтоЧекКоррекции, ЗапрашиватьКонтактнуюИнформацию");
	...
	ПолученоНаличными = ?(Параметры.ЭтоВозврат ИЛИ Параметры.ЭтоЧекКоррекции, СуммаДокумента, 0);
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.СуммаСдача.Видимость                       = НЕ Форма.ЭтоВозврат И НЕ Форма.ЭтоЧекКоррекции;
	Элементы.ПолученоНаличными.Видимость                = НЕ Форма.ЭтоВозврат И НЕ Форма.ЭтоЧекКоррекции;
	...
	Элементы.ПечататьТоварныйЧек.Видимость              = НЕ Форма.ЭтоЧекКоррекции;

...
Функция ОбработатьДанныеШтрихкода(Форма, ДанныеШтрихкода, ПараметрыСканирования, ВложенныеШтрихкоды = Неопределено) Экспорт
	...
	ИначеЕсли ДанныеШтрихкода.ВидПродукции = Перечисления.ВидыПродукцииИС.Обувь Тогда
		...
		Возврат ОбработатьДанныеШтрихкодаЕдиницыОбувнойПродукции(Форма, ДанныеШтрихкода, ПараметрыСканирования);
...
#Область ОбувнаяПродукция

Функция ОбработатьДанныеШтрихкодаЕдиницыОбувнойПродукции(Форма, ДанныеШтрихкода, ПараметрыСканирования, ПараметрыЗаполнения = Неопределено)
	...
	НоваяСтрокаТовары = Объект.Товары.Добавить();
	НоваяСтрокаТовары.Номенклатура = ДанныеШтрихкода.Номенклатура;
	НоваяСтрокаТовары.Количество   = ДанныеШтрихкода.КоличествоВложенныхЕдиниц;
...
Функция СформироватьОтчетыОРозничныхПродажах(Организация, ИдентификаторУстройства) Экспорт
	...
	ТаблицаВозвратОплаты.Свернуть("Организация, Склад, ВидОплаты, СчетКасса", "СуммаОплаты");
	ТаблицаОплаты.Свернуть("Организация, Склад, ВидОплаты, СчетКасса", "СуммаОплаты");

...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ТекстНеобходимоЗаполнитьПатент.Видимость = (НЕ ЭтоОборудование)
...
&НаСервереБезКонтекста
Процедура ЗаполнитьДобавленныеКолонкиСтрокиТаблицыТовары(СтрокаТаблицы, Знач РеквизитыСчетовНаОплату, Знач ПараметрыОбъекта)

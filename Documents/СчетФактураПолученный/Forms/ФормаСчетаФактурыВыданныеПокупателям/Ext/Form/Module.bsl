...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИсточникВыбора.ИмяФормы = "Документ.СчетФактураВыданный.Форма.ФормаВыбора" Тогда
		...
		ЗаполнитьТаблицуСчетФактурНаСервере(ВыбранноеЗначение);
...
&НаКлиенте
Процедура ЗаполнитьПоНомеруСчетаФактуры(Команда)
...
&НаСервере
Процедура ЗаполнитьТаблицуСчетФактурНаСервере(ВыбранноеЗначение)
	...
	ТаблицаСчетовФактур = Документы.СчетФактураПолученный.СчетаФактурыВыданныеПокупателям(ПараметрыЗапроса);
	
	Для каждого ТекущаяСтрокаТаблицаСчетовФактур Из ТаблицаСчетовФактур Цикл
		
		Если НЕ ВыбранноеЗначение = ТекущаяСтрокаТаблицаСчетовФактур.СчетФактура Тогда
			Продолжить;
		КонецЕсли;

...
Процедура ПодготовитьФормуНаСервере()
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка) и РольДоступна("ПростоеСписаниеПоТребованию") Тогда
		Объект.ПростоеСписание=Истина;
		Объект.СчетаУчетаЗатратВТаблице=Истина;
	КонецЕсли;
	
	Если РольДоступна("ПростоеСписаниеПоТребованию") Тогда
		//Элементы.СтраницаМатериалы..КолонкиМатериалы.НоменклатурнаяГруппа.Видимость=Ложь;
		//КолонкиМатериалы.СчетЗатрат.Видимость =Ложь;
		Элементы.СтраницаСчетЗатрат.Видимость=Ложь;
		//ЭлементыФормы.ОсновнаяПанель.Страницы.Дополнительно.Видимость=Ложь;
		Элементы.СтраницаМатериалыЗаказчика.Видимость=Ложь;
		Элементы.СчетаУчетаЗатратВТаблице.Видимость=Ложь;
	КонецЕсли;

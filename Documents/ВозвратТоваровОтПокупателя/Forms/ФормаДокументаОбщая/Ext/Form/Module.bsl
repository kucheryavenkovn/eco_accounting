...
Процедура ОтобразитьПолеУКД(Форма) Экспорт
	...
	Элементы.ПредставлениеУКД.Видимость = Объект.ЭтоУниверсальныйДокумент;
...
Процедура ВидОперацииОбработатьИзменение()
	...
	Если Объект.ВидОперации <> Перечисления.ВидыОперацийВозвратТоваровОтПокупателя.Товары Тогда
		Объект.ДеятельностьНаПатенте = Ложь;
...
Функция ПолучитьМассивВидовДоговоров(ВидОперации)
	...
	Если ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийВозвратТоваровОтПокупателя.ОтгруженныеТовары") Тогда
...
Процедура УстановитьПараметрыВыбора(Форма)
	...
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийВозвратТоваровОтПокупателя.ОтгруженныеТовары") Тогда

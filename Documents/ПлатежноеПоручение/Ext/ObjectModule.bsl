...
Процедура ЗаполнитьПоДокументуОснованию(Основание)
	...
	Если ВидДокументаОснования    = Тип("ДокументСсылка.ПоступлениеТоваровУслуг")
		...
		// patimka
		ИЛИ ВидДокументаОснования = Тип("ДокументСсылка.ЗаявкаНаРасходованиеСредств")
		...
		Иначе
			...
			// patimka
		ИначеЕсли ВидДокументаОснования = Тип("ДокументСсылка.ЗаявкаНаРасходованиеСредств") Тогда
				СчетКонтрагента = Основание.БанковскийСчетДляОплаты;		
				...
				СтрокаТаблицыСумм.СтавкаНДС    = Перечисления.СтавкиНДС.НДС18;
				ПроцентНДС = УчетНДСВызовСервераПовтИсп.ПолучитьСтавкуНДС(СтрокаТаблицыСумм.СтавкаНДС);
				СтрокаТаблицыСумм.СуммаПлатежа = Основание.СуммаПлатежа;
				СтрокаТаблицыСумм.СуммаНДС     = Окр(СтрокаТаблицыСумм.СуммаПлатежа * ПроцентНДС / (100 + ПроцентНДС), 2);

...
Функция ТекстЗапросаДанныеДляПечатиСчетовФактур(НомераТаблиц) Экспорт
	...
	|		КОГДА НЕ АР_НачислениеАренднойПлаты.Ссылка ЕСТЬ NULL
	|			ТОГДА АР_НачислениеАренднойПлаты.Дата
	|		КОГДА НЕ АР_НачислениеПени.Ссылка ЕСТЬ NULL
	|			ТОГДА АР_НачислениеПени.Дата
	...
	//++ЭЛИАС 20190424 
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.АР_НачислениеАренднойПлаты КАК АР_НачислениеАренднойПлаты
	|		ПО Реквизиты.ИсправляемыйДокументРеализации = АР_НачислениеАренднойПлаты.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.АР_НачислениеПени КАК АР_НачислениеПени
	|		ПО Реквизиты.ИсправляемыйДокументРеализации = АР_НачислениеПени.Ссылка
	//--ЭЛИАС 20190424
	...
	|	ВЫРАЗИТЬ(ТаблицаТовары.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) КАК ТоварНаименование, //++ЭЛИАС 20130504
	...
	|	ВЫРАЗИТЬ(ТаблицаУслуги.Содержание КАК СТРОКА(1000)), //++ЭЛИАС 20130504
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	...
	|	ВЫРАЗИТЬ(ТаблицаАгентскиеУслуги.Содержание КАК СТРОКА(1000)), //++ЭЛИАС 20130504
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	...
	|	ТаблицаУслуги.Номенклатура.Код,
	|	ТаблицаУслуги.Номенклатура.КодОКВЭД2,
	|	ВЫРАЗИТЬ(ТаблицаУслуги.Содержание КАК СТРОКА(1000)),
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	|	ЕСТЬNULL(&ЕдиницаИзмеренияШтука, ТаблицаУслуги.Номенклатура.ЕдиницаИзмерения),
	|	1,
	|	СУММА(ТаблицаУслуги.Сумма),
	|	СУММА(ТаблицаУслуги.Сумма),
	|	СУММА(ТаблицаУслуги.СуммаНДС),
	|	ТаблицаУслуги.СтавкаНДС,
	|	СУММА(ТаблицаУслуги.СуммаДоИзменения),
	|	СУММА(ТаблицаУслуги.СуммаНДСДоИзменения),
	|	СУММА(ТаблицаУслуги.СуммаДоКорректировки),
	|	СУММА(ТаблицаУслуги.СуммаНДСДоКорректировки),
	|	ИСТИНА,
	|	ТаблицаУслуги.Ссылка.СуммаВключаетНДС,
	|	ТаблицаУслуги.Ссылка,
	|	ЛОЖЬ,
	|	СУММА(ЕСТЬNULL(РегистрСведенийРублевыеСуммыДокументовВВалюте.ВсегоРуб, 0)),
	|	СУММА(ЕСТЬNULL(РегистрСведенийРублевыеСуммыДокументовВВалюте.СуммаБезНДСРуб, 0)),
	|	СУММА(ЕСТЬNULL(РегистрСведенийРублевыеСуммыДокументовВВалюте.НДСРуб, 0)),
	|	ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка),
	|	НЕОПРЕДЕЛЕНО,
	|	ЗНАЧЕНИЕ(Справочник.КлассификаторТНВЭД.ПустаяСсылка)
	|ИЗ
	...
	|ВЫБРАТЬ
	|	3,
	|	МИНИМУМ(ТаблицаАгентскиеУслуги.НомерСтроки),
	|	ТаблицаАгентскиеУслуги.Номенклатура,
	|	ТаблицаАгентскиеУслуги.Номенклатура.Код,
	|	ТаблицаАгентскиеУслуги.Номенклатура.КодОКВЭД2,
	|	ВЫРАЗИТЬ(ТаблицаАгентскиеУслуги.Содержание КАК СТРОКА(1000)),
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	|	ЕСТЬNULL(&ЕдиницаИзмеренияШтука, ТаблицаАгентскиеУслуги.Номенклатура.ЕдиницаИзмерения),
	|	1,
	|	СУММА(ТаблицаАгентскиеУслуги.Сумма),
	|	СУММА(ТаблицаАгентскиеУслуги.Сумма),
	|	СУММА(ТаблицаАгентскиеУслуги.СуммаНДС),
	|	ТаблицаАгентскиеУслуги.СтавкаНДС,
	|	СУММА(ТаблицаАгентскиеУслуги.СуммаДоИзменения),
	|	СУММА(ТаблицаАгентскиеУслуги.СуммаНДСДоИзменения),
	|	СУММА(ТаблицаАгентскиеУслуги.СуммаДоКорректировки),
	|	СУММА(ТаблицаАгентскиеУслуги.СуммаНДСДоКорректировки),
	|	ИСТИНА,
	|	ТаблицаАгентскиеУслуги.Ссылка.СуммаВключаетНДС,
	|	ТаблицаАгентскиеУслуги.Ссылка,
	|	ИСТИНА,
	...
	|	"""",
	|	""Оплата пени "" + ВЫБОР
	|		КОГДА ЕСТЬNULL(ТаблицаАгентскиеУслуги.Номенклатура.АР_ПостояннаяЧастьОплаты, ИСТИНА)
	|			ТОГДА """"
	|		ИНАЧЕ ""(переменная часть)""
	|	КОНЕЦ + "" по договору "" + ТаблицаАгентскиеУслуги.Ссылка.ДоговорКонтрагента.Наименование + "" по состоянию на "" + &ПредставлениеПериода,
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	...
	|	"""",
	|	ТаблицаАгентскиеУслуги.Номенклатура.ЕдиницаИзмерения,
	|	СУММА(ТаблицаАгентскиеУслуги.Количество),
	|	ТаблицаАгентскиеУслуги.Цена,
	|	СУММА(ТаблицаАгентскиеУслуги.Сумма),
	|	СУММА(ТаблицаАгентскиеУслуги.СуммаНДС),
	|	ТаблицаАгентскиеУслуги.СтавкаНДС,
	...
	|	ТаблицаУслуги.Номенклатура.Код,
	|	ТаблицаУслуги.Номенклатура.КодОКВЭД2,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(ТаблицаУслуги.Содержание КАК Строка(1000)) + "" по договору "" + ТаблицаУслуги.Ссылка.ДоговорКонтрагента.Наименование + "" за "" + &ПредставлениеПериода КАК СТРОКА(1000)),
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	...
	|	ТаблицаАгентскиеУслуги.Номенклатура.Код,
	|	ТаблицаАгентскиеУслуги.Номенклатура.КодОКВЭД2,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(ТаблицаАгентскиеУслуги.Содержание КАК Строка(1000)) + "" по договору "" + ТаблицаАгентскиеУслуги.Ссылка.ДоговорКонтрагента.Наименование + "" за "" + &ПредставлениеПериода КАК СТРОКА(1000)),
	|	"""",
	|	"""",
	|	"""",
	|	"""",
...
Функция ТекстЗапросаДанныеДляПечатиКорректировочныхСчетовФактур(НомераТаблиц) Экспорт
	...
	|	ВЫРАЗИТЬ(ТаблицаНоменклатуры.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) КАК ТоварНаименование, //++ЭЛИАС 20141104  
	...
	|	ТаблицаНоменклатуры.Номенклатура.КодОКВЭД2,
	|	ВЫРАЗИТЬ(ТаблицаНоменклатуры.Содержание КАК СТРОКА(1000)),  //++ЭЛИАС 20141104  
	|	"""",
	|	"""",
	|	"""",
	|	"""",
	...
	|	ВЫРАЗИТЬ(ТаблицаНоменклатуры.ТоварНаименование КАК СТРОКА(1000)) КАК ТоварНаименование,   //++ЭЛИАС 20141104  
	|	ТаблицаНоменклатуры.СтранаПроисхождения КАК СтранаПроисхождения,
	...
	|
	|ВЫБРАТЬ
	|	ТаблицаНоменклатуры.НомерТабЧасти,
	|	МИНИМУМ(ТаблицаНоменклатуры.НомерСтроки),
	|	ТаблицаНоменклатуры.Товар,
	|	ТаблицаНоменклатуры.ТоварКод,
	|	ТаблицаНоменклатуры.ТоварАртикул,
	|	ВЫРАЗИТЬ(ТаблицаНоменклатуры.ТоварНаименование КАК СТРОКА(1000)),
	|	ТаблицаНоменклатуры.СтранаПроисхождения,
	|	ТаблицаНоменклатуры.ПредставлениеСтраны,
	|	ТаблицаНоменклатуры.НомерГТД,
	|	ТаблицаНоменклатуры.ПредставлениеГТД,
	|	ВЫБОР
	|		КОГДА &ЭтоПени
	|			ТОГДА &ЕдиницаИзмеренияШтука
	|		ИНАЧЕ ТаблицаНоменклатуры.ЕдиницаИзмерения
	|	КОНЕЦ,
	|	СУММА(ВЫБОР
	|			КОГДА &ЭтоПени
	|				ТОГДА 1
	...
	|			КОГДА &ЭтоПени
	|				ТОГДА 1
	|			ИНАЧЕ ТаблицаНоменклатуры.КоличествоПослеИзменения
	|		КОНЕЦ),
	|	СУММА(ВЫБОР
	|			КОГДА &ЭтоПени
	|				ТОГДА ТаблицаНоменклатуры.СтоимостьБезНДСДоИзменения
	|			ИНАЧЕ ВЫБОР
	|					КОГДА ТаблицаНоменклатуры.КоличествоДоИзменения = 0
	|						ТОГДА 0
	...
	|		КОНЕЦ),
	|	СУММА(ТаблицаНоменклатуры.СтоимостьБезНДСДоИзменения),
	|	СУММА(ТаблицаНоменклатуры.СтоимостьБезНДСПослеИзменения),
	|	СУММА(ТаблицаНоменклатуры.СуммаНДСПослеИзменения),
	|	СУММА(ТаблицаНоменклатуры.СуммаНДСДоИзменения),
	|	СУММА(ТаблицаНоменклатуры.СтоимостьСНДСДоИзменения),
	|	СУММА(ТаблицаНоменклатуры.СтоимостьСНДСПослеИзменения),
	|	СУММА(ВЫБОР
	|			КОГДА ТаблицаНоменклатуры.СтоимостьБезНДСДоИзменения > ТаблицаНоменклатуры.СтоимостьБезНДСПослеИзменения
	|				ТОГДА ТаблицаНоменклатуры.СтоимостьБезНДСДоИзменения - ТаблицаНоменклатуры.СтоимостьБезНДСПослеИзменения
	|			ИНАЧЕ 0
	...
	|	ТаблицаНоменклатуры.СтавкаНДС КАК СтавкаНДСДоИзменения,
	|	ТаблицаНоменклатуры.СтавкаНДС КАК СтавкаНДСПослеИзменения,
	|	ТаблицаНоменклатуры.ЭтоУслуга,
	|	ТаблицаНоменклатуры.Ссылка,
	|	ТаблицаНоменклатуры.ТоварыКодТНВЭД,
	|	ТаблицаНоменклатуры.ТоварыКодТНВЭДДоИзменения
	|ИЗ
	|	ТаблицаНоменклатуры КАК ТаблицаНоменклатуры
	|ГДЕ
	|	(ТаблицаНоменклатуры.КоличествоПослеИзменения <> ТаблицаНоменклатуры.КоличествоДоИзменения
	...
	|		ИНАЧЕ ТаблицаНоменклатуры.Товар
	|	КОНЕЦ,
	|	ВЫБОР
	|		КОГДА &ЭтоПени
	|			ТОГДА """"
	|		ИНАЧЕ ТаблицаНоменклатуры.ТоварКод
	|	КОНЕЦ,
	|	ВЫБОР
	|		КОГДА &ЭтоПени
	|			ТОГДА """"
	|		ИНАЧЕ ТаблицаНоменклатуры.ТоварАртикул
	|	КОНЕЦ,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА &ЭтоПени
	|			ТОГДА ""Оплата пени "" + ВЫБОР
	|					КОГДА ЕСТЬNULL(ТаблицаНоменклатуры.Товар.АР_ПостояннаяЧастьОплаты, ИСТИНА)
	|						ТОГДА """"
	|					ИНАЧЕ ""(переменная часть)""
	|				КОНЕЦ + "" по договору "" + ТаблицаНоменклатуры.Ссылка.ДоговорКонтрагента.Наименование + "" по состоянию на "" + &ПредставлениеПериода
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаНоменклатуры.ТоварНаименование КАК СТРОКА(1000))) + "" по договору "" + ТаблицаНоменклатуры.Ссылка.ДоговорКонтрагента.Наименование + "" за "" + &ПредставлениеПериода
...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ, ДоговорДляОтложенногоПроведения = Неопределено) Экспорт
	...
	Реквизиты.Вставить("ЭтоАренда", Ложь); //СВД
	...
	Если Реквизиты.РасчетыВВалюте 
		...
		Иначе
			...
			Если СтрНайти(ИмяДокументаРеализации, "СчетФактура") = 0 
				...
				//++ЭЛИАС 20130707  
				ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ЕдиницаИзмеренияШтука", 
					Справочники.КлассификаторЕдиницИзмерения.ПолучитьЕдиницуИзмеренияПоУмолчанию());
				ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("СчетФактураСводный", ЛОЖЬ);
				Если ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты")
					ИЛИ (ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.КорректировкаРеализации") 
					И ТипЗнч(Реквизиты.ДокументРеализации.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты")) Тогда
					ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ЭтоАренда", Истина);
					ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ЭтоПени", Ложь);
					Если ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты") Тогда
						ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ПредставлениеПериода", ПредставлениеПериода(Реквизиты.ДокументРеализации.НачалоПериода, КонецДня(Реквизиты.ДокументРеализации.ОкончаниеПериода)));
					Иначе
						ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ПредставлениеПериода", ПредставлениеПериода(Реквизиты.ДокументРеализации.ДокументРеализации.НачалоПериода, КонецДня(Реквизиты.ДокументРеализации.ДокументРеализации.ОкончаниеПериода)));
					КонецЕсли;
				ИначеЕсли ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеПени")
					ИЛИ (ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.КорректировкаРеализации") 
					И ТипЗнч(Реквизиты.ДокументРеализации.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеПени")) Тогда
					ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ЭтоАренда", Истина);
					ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ЭтоПени", Истина);
					Если ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеПени") Тогда
						ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ПредставлениеПериода", Формат(Реквизиты.ДокументРеализации.Дата,"ДФ='дд.ММ.гггг'"));
					Иначе
						ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ПредставлениеПериода", Формат(Реквизиты.ДокументРеализации.ДокументРеализации.Дата,"ДФ='дд.ММ.гггг'"));
					КонецЕсли;
				Иначе
					ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ЭтоАренда", Ложь);
					ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ЭтоПени", Ложь);
					ЗапросДляОпределенияКурсаПервичногоДокумента.УстановитьПараметр("ПредставлениеПериода", "");
				КонецЕсли;
				//--ЭЛИАС 20130707
	...
	//++ЭЛИАС 20130614
	АР_ИсправляемыйДокумент = УчетНДСПереопределяемый.ПолучитьИсправляемыйДокументРеализации(ИсправляемыйДокумент, Истина);	
	Запрос.УстановитьПараметр("ЭтоАренда", ТипЗнч(АР_ИсправляемыйДокумент) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты")
		ИЛИ ТипЗнч(АР_ИсправляемыйДокумент) = Тип("ДокументСсылка.АР_НачислениеПени"));
	Запрос.УстановитьПараметр("ЭтоПени", ТипЗнч(АР_ИсправляемыйДокумент) = Тип("ДокументСсылка.АР_НачислениеПени"));
	Запрос.УстановитьПараметр("ОбособленныйУчетПени", АР_ПроцедурыНачисления.ПоДоговорамЕстьОбособленныйУчетПени(АР_ИсправляемыйДокумент,, Реквизиты.ДоговорКонтрагента));
	//--ЭЛИАС 20130614
	...
	Запрос.Текст = ТекстЗапросаСписаниеТоваров(НомераТаблиц, ПараметрыПроведения, Реквизиты)
		...
		//++ЭЛИАС 20120710
		+ ТекстЗапросаВзаиморасчетыПоАренде(НомераТаблиц, ПараметрыПроведения, Реквизиты) 
		+ ТекстЗапросаПродажиПоАренде(НомераТаблиц, ПараметрыПроведения, Реквизиты)
		//--ЭЛИАС 20120710
...
Функция ТекстЗапросаРеквизитыДокумента(НомераТаблиц)
	...
	//++ЭЛИАС 20120710
	|	ВЫБОР
	|		КОГДА Реквизиты.ДокументРеализации ССЫЛКА Документ.АР_НачислениеАренднойПлаты
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ЭтоНачислениеАренднойПлаты,
	|	ВЫБОР
	|		КОГДА Реквизиты.ДокументРеализации ССЫЛКА Документ.АР_НачислениеПени
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ЭтоНачислениеПени,
	|	ВЫБОР
	|		КОГДА (Реквизиты.ДокументРеализации ССЫЛКА Документ.АР_НачислениеАренднойПлаты) ИЛИ (Реквизиты.ДокументРеализации ССЫЛКА Документ.АР_НачислениеПени)
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ЭтоАренда,
	...
	|	Реквизиты.СуммаВключаетНДС КАК СуммаВключаетНДС,
	//++ЭЛИАС 20120710
	|	Реквизиты.ЭтоНачислениеАренднойПлаты,
	|	Реквизиты.ЭтоНачислениеПени,
	|	Реквизиты.ЭтоАренда,
...
Функция ТекстЗапросаРеализация(НомераТаблиц, ПараметрыПроведения, Реквизиты)
	...
	Если Реквизиты.ЕстьТовары Тогда
		...
		|	Значение(Справочник.Номенклатура.ПустаяСсылка) КАК УслугаАренды,
		|	Значение(Документ.АР_СчетНаАренду.ПустаяСсылка) КАК СчетНаАренду,
		|	ДатаВремя(1,1,1) КАК ПериодАренды,
		//--ЭЛИАС 20130614
...
Функция ТекстЗапросаЗачетАвансов(НомераТаблиц, ПараметрыПроведения, Реквизиты)
	...
	"ВЫБРАТЬ
	//++ЭЛИАС 20130614
	|	ТаблицаСуммВзаиморасчетов.ОбъектАренды,
	|	ТаблицаСуммВзаиморасчетов.УслугаАренды,
	|	ТаблицаСуммВзаиморасчетов.СчетНаАренду,
	|	ТаблицаСуммВзаиморасчетов.ПериодАренды,
	//--ЭЛИАС 20130614
	...
	//++ЭЛИАС 20130614
	|		ТаблицаУслуги.ОбъектАренды,
	|		ВЫБОР КОГДА &ЭтоАренда ИЛИ &ЭтоПени ТОГДА ТаблицаУслуги.УслугаАренды ИНАЧЕ Значение(Справочник.Номенклатура.ПустаяСсылка) КОНЕЦ,
	|		ТаблицаУслуги.СчетНаАренду,
	|		ТаблицаУслуги.ПериодАренды,
	//--ЭЛИАС 20130614
	...
	//++ЭЛИАС 20130614
	|		ТаблицаАгентскиеУслуги.ОбъектАренды,
	|		ВЫБОР КОГДА &ЭтоАренда ИЛИ &ЭтоПени ТОГДА ТаблицаАгентскиеУслуги.УслугаАренды ИНАЧЕ Значение(Справочник.Номенклатура.ПустаяСсылка) КОНЕЦ,
	|		ТаблицаАгентскиеУслуги.СчетНаАренду,
	|		ТаблицаАгентскиеУслуги.ПериодАренды,
	//--ЭЛИАС 20130614
	...
	|		ИЗ
	|			ТаблицаСуммВзаиморасчетов КАК Таблица) КАК ТаблицаСуммВзаиморасчетов
	|		ПО (ИСТИНА)
	//--ЭЛИАС 20130614
	|;
	|
...
//++ЭЛИАС 20120710
Функция ТекстЗапросаВзаиморасчетыПоАренде(НомераТаблиц, ПараметрыПроведения, Реквизиты)

	//TODO Кто вносил изменения?
	//НомераТаблиц.Вставить("ВзаиморасчетыПоАрендеРеквизиты", НомераТаблиц.Количество());
	//Если Реквизиты.ЭтоАренда И (Реквизиты.ЕстьУслуги ИЛИ Реквизиты.ЕстьАгентскиеУслуги) Тогда
	//	НомераТаблиц.Вставить("ВзаиморасчетыПоАренде", НомераТаблиц.Количество());
	//Иначе
		ПараметрыПроведения.Вставить("ВзаиморасчетыПоАренде", Неопределено);
	//КонецЕсли;
	...
	//// ВзаиморасчетыПоАренде
	//Если Реквизиты.ЭтоАренда И Реквизиты.ЕстьУслуги Тогда
	//	ТекстЗапроса = ТекстЗапроса +
	//	"ВЫБРАТЬ
	//	|	Реквизиты.Дата КАК Период,
	...
	//	|	ТаблицаУслуги.СуммаВзаиморасчетов - ТаблицаУслуги.СуммаВзаиморасчетовДоИзменения КАК СуммаВзаиморасчетов,
	//	|	ТаблицаУслуги.СуммаРуб - ТаблицаУслуги.СуммаРубДоИзменения КАК Сумма,
	//	|	Реквизиты.ЭтоНачислениеПени КАК Пени,
	//	|	Реквизиты.ДокументРеализации КАК ДокументРасчетов
	//	|ИЗ
	//	|	ТаблицаУслуги КАК ТаблицаУслуги
	...
	//	|ГДЕ
	//	|	ТаблицаУслуги.СуммаВзаиморасчетов <> ТаблицаУслуги.СуммаВзаиморасчетовДоИзменения
	//	|	И Реквизиты.КорректироватьБУиНУ
	//	|	И (Реквизиты.ЭтоНачислениеАренднойПлаты
	//	|			ИЛИ Реквизиты.ЭтоНачислениеПени)";
	//КонецЕсли;
	//
	//Если Реквизиты.ЭтоАренда И Реквизиты.ЕстьУслуги И Реквизиты.ЕстьАгентскиеУслуги Тогда
	//	
	//	ТекстЗапроса = ТекстЗапроса + "
	//	|
	//	|ОБЪЕДИНИТЬ ВСЕ
	...
	//КонецЕсли;	
	//
	//Если Реквизиты.ЭтоАренда И Реквизиты.ЕстьАгентскиеУслуги Тогда
	//	ТекстЗапроса = ТекстЗапроса +
	//	"ВЫБРАТЬ
	//	|	Реквизиты.Дата КАК Период,
	//	|	ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход) КАК ВидДвижения,
	...
	//	|	ТаблицаАгентскиеУслуги.СуммаВзаиморасчетов - ТаблицаАгентскиеУслуги.СуммаВзаиморасчетовДоИзменения КАК СуммаВзаиморасчетов,
	//	|	ТаблицаАгентскиеУслуги.СуммаРуб - ТаблицаАгентскиеУслуги.СуммаРубДоИзменения КАК Сумма,
	//	|	Реквизиты.ЭтоНачислениеПени КАК Пени,
	//	|	Реквизиты.ДокументРеализации КАК ДокументРасчетов
	//	|ИЗ
	//	|	ТаблицаАгентскиеУслуги КАК ТаблицаАгентскиеУслуги
...
КонецФункции //--ЭЛИАС 20120710 

//++ЭЛИАС 20120710
Функция ТекстЗапросаПродажиПоАренде(НомераТаблиц, ПараметрыПроведения, Реквизиты)

	НомераТаблиц.Вставить("ПродажиПоАрендеРеквизиты", НомераТаблиц.Количество());
	Если Реквизиты.ЭтоАренда И Реквизиты.ЕстьУслуги Тогда
		НомераТаблиц.Вставить("ПродажиПоАренде", НомераТаблиц.Количество());
	Иначе
		ПараметрыПроведения.Вставить("ПродажиПоАренде", Неопределено);
	КонецЕсли;
	
	// ПродажиПоАрендеРеквизиты
	ТекстЗапроса = 
	"ВЫБРАТЬ
	|	&ДокументРеализацииСсылка КАК ДокументРеализации,
	|	Реквизиты.ДоговорКонтрагента,
...
Функция ПодготовитьПараметрыТаблицыАвансовОплат(ТаблицаВзаиморасчетов, ТаблицаРеквизиты)
	...
	ЭтоАренда = ТаблицаРеквизиты <> Неопределено И ТаблицаРеквизиты.Колонки.Найти("ЭтоАренда") <> Неопределено И ТаблицаРеквизиты[0].ЭтоАренда; //++ЭЛИАС 20130918
	...
	Если ЭтоАренда Тогда
		...
		+ "Пени,"              // <Булево> - Истина при начислении пени
		+ "Депозит,"              // <Булево> - Истина, если используется депозит для зачета
		+ "ОбъектАрендыДокумент,"              // <СправочникСсылка.АР_ОбъектыАренды> - объект аренды, аванс по которому зачитывается
		+ "УслугаАрендыДокумент,"              // <СправочникСсылка.Номенклатура> - услуга, аванс по которому зачитывается
		+ "СчетНаАрендуДокумент,"              // <ДокументСсылка.АР_СчетНаАренду> - счет на аренду, аванс по которому зачитывается
		+ "ПериодАрендыДокумент,"              // <Дата> - период, за который зачитывается аванс
		+ "ПениДокумент,"              // <Булево> - Истина при начислении пени
		+ "ДепозитДокумент";              // <Булево> - Истина, если используется депозит для зачета
	КонецЕсли;
	//--ЭЛИАС 20130918
	...
	+ "ДоговорКонтрагента,"           // <Справочник.ДоговорыКонтрагентов>
  	+ "ЭтоАренда";                 //++ЭЛИАС 20130918 <Булево> - Истина при взаиморасчетах по аренде
...
Функция ПодготовитьПараметрыТаблицыДокументаПоВыделениюАванса(ТаблицаРеквизиты, ТаблицыВыделенияАвансов)
	...
	ЭтоАренда = ТаблицаРеквизиты <> Неопределено И ТаблицаРеквизиты.Колонки.Найти("ЭтоАренда") <> Неопределено И ТаблицаРеквизиты[0].ЭтоАренда; //++ЭЛИАС 20171024 
...
//++ЭЛИАС 20120710
Процедура ПодготовитьТаблицуДокументаДляВзаиморасчетовПоАренде(ТаблицаВзаиморасчеты, ТаблицаРеквизиты, ЭтоВзаиморасчеты = Ложь) Экспорт
	
	Если ТаблицаВзаиморасчеты = Неопределено Тогда
		Возврат;
	КонецЕсли;
	...
	Если ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты") Тогда
		НачалоПериода = Реквизиты.ДокументРеализации.НачалоПериода;
	ИначеЕсли ТипЗнч(Реквизиты.ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеПени") Тогда
		НачалоПериода = Реквизиты.ДокументРеализации.Дата;
	Иначе
		Возврат;
	КонецЕсли;
	
	НачалоПериода = АР_ОбщиеПроцедуры.ОпределитьНачалоПериодаОплатыПоДоговору(НачалоПериода, Реквизиты.ДоговорКонтрагента);
	Для Каждого СтрокаТаблицы Из ТаблицаВзаиморасчеты Цикл
		...
		КонецЕсли;
		Если ЭтоВзаиморасчеты И НЕ Реквизиты.ВестиВзаиморасчетыПоОбъектам Тогда
			СтрокаТаблицы.ОбъектАренды = Справочники.АР_ОбъектыАренды.ПустаяСсылка();
		КонецЕсли;
		Если ЭтоВзаиморасчеты И НЕ Реквизиты.ВестиВзаиморасчетыПоУслугам Тогда
			СтрокаТаблицы.УслугаАренды = Справочники.Номенклатура.ПустаяСсылка();
		КонецЕсли;
		Если ЭтоВзаиморасчеты И Не Реквизиты.ВестиВзаиморасчетыПоПериодам Тогда
			СтрокаТаблицы.ПериодАренды = '00010101';
		КонецЕсли;
		Если ЭтоВзаиморасчеты И НЕ ТаблицаВзаиморасчеты.Колонки.Найти("СчетНаАренду") = Неопределено Тогда
			Если ЗначениеЗаполнено(СтрокаТаблицы.УслугаАренды) Тогда
				Если (СтрокаТаблицы.УслугаАренды.АР_ПостояннаяЧастьОплаты И Не Реквизиты.ВестиВзаиморасчетыПоСчетамПост) 
					...
					СтрокаТаблицы.СчетНаАренду = Документы.АР_СчетНаАренду.ПустаяСсылка();
				КонецЕсли;
			Иначе
...
Функция ДоступнаКорректировкаБУиНУ(ДокументРеализации) Экспорт
	...
	ИначеЕсли ТипЗнч(ДокументРеализации) = Тип("ДокументСсылка.КорректировкаРеализации") Тогда
		...
		//++ЭЛИАС 20130322  
	ИначеЕсли ТипЗнч(ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты") Тогда
		Возврат Истина;
	ИначеЕсли ТипЗнч(ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеПени") Тогда
		Возврат Истина;
		//--ЭЛИАС 20130322	
	Иначе
		Возврат Ложь;
...
Функция ДанныеЗаполненияПоДокументу(ДокументРеализации) Экспорт
	...
	ИначеЕсли ТипЗнч(ДокументРеализации) = Тип("ДокументСсылка.ОтчетКомиссионераОПродажах") Тогда
		...
		//++ЭЛИАС 20120710
	ИначеЕсли ТипЗнч(ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты")
		ИЛИ ТипЗнч(ДокументРеализации) = Тип("ДокументСсылка.АР_НачислениеПени") Тогда

		ДанныеЗаполнения = ДанныеЗаполненияПоАренде(ДокументРеализации);
		//--ЭЛИАС 20120710
...
//++ЭЛИАС 20120710 заполнение документов аренды
Функция ДанныеЗаполненияПоАренде(ДокументРеализации)

	МетаданныеДокумента = ДокументРеализации.Метаданные();
	ИмяВидаДокумента = МетаданныеДокумента.Имя;
	НачислениеАренды = ИмяВидаДокумента = "АР_НачислениеАренднойПлаты";
	НачислениеПени = ИмяВидаДокумента = "АР_НачислениеПени";
	...
	Текст =
	  "ВЫБРАТЬ
	|	ВЫБОР
	|		КОГДА АР_НачислениеАренднойПлатыСостав.Контрагент = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|			ТОГДА ""Услуги""
	|		ИНАЧЕ ""АгентскиеУслуги""
	|	КОНЕЦ КАК ТЧ,
	|	ИСТИНА КАК ЕстьВДокументеРеализации,
	|	АР_НачислениеАренднойПлатыСостав.Номенклатура,
	|	АР_НачислениеАренднойПлатыСостав.ОбъектАренды,
	|	АР_НачислениеАренднойПлатыСостав.ПериодАренды,
	|	АР_НачислениеАренднойПлатыСостав.СчетНаАренду,";
	Если НачислениеАренды Тогда
		Текст = Текст + "
		|	АР_НачислениеАренднойПлатыСостав.Количество,
		|	АР_НачислениеАренднойПлатыСостав.Количество КАК КоличествоДоИзменения,
		|	АР_НачислениеАренднойПлатыСостав.Цена,
		|	АР_НачислениеАренднойПлатыСостав.Цена КАК ЦенаДоИзменения,";
	КонецЕсли;
	Текст = Текст + "
	|	АР_НачислениеАренднойПлатыСостав.Сумма,
	|	АР_НачислениеАренднойПлатыСостав.Сумма КАК СуммаДоИзменения,
	|	АР_НачислениеАренднойПлатыСостав.СтавкаНДС,
	|	АР_НачислениеАренднойПлатыСостав.СтавкаНДС КАК СтавкаНДСДоИзменения,
	|	АР_НачислениеАренднойПлатыСостав.СуммаНДС,
	|	АР_НачислениеАренднойПлатыСостав.СуммаНДС КАК СуммаНДСДоИзменения,
	|	АР_НачислениеАренднойПлатыСостав.СчетУчетаНДСПоРеализации,
	|	АР_НачислениеАренднойПлатыСостав.СчетДоходов,
	|	АР_НачислениеАренднойПлатыСостав.СчетРасходов,
	|	АР_НачислениеАренднойПлатыСостав.Субконто,
	|	АР_НачислениеАренднойПлатыСостав.Контрагент,
	|	АР_НачислениеАренднойПлатыСостав.ДоговорКонтрагента,
	|	АР_НачислениеАренднойПлатыСостав.СчетРасчетов,
	|	АР_НачислениеАренднойПлатыСостав.Содержание,
	|	АР_НачислениеАренднойПлатыСостав.Содержание КАК СодержаниеДоИзменения
	|ИЗ
	|	Документ." + ИмяВидаДокумента + ".Состав КАК АР_НачислениеАренднойПлатыСостав
	|ГДЕ
...
Функция ПолучитьТаблицуСведенийАктаОбОказанииУслуг(Знач СписокДокументов) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ТипЗнч(Выборка.ИсправляемыйДокументРеализации) <> Тип("ДокументСсылка.РеализацияТоваровУслуг")
			//++ЭЛИАС 20140625  
			И ТипЗнч(Выборка.ИсправляемыйДокументРеализации) <> Тип("ДокументСсылка.АР_НачислениеАренднойПлаты")
			И ТипЗнч(Выборка.ИсправляемыйДокументРеализации) <> Тип("ДокументСсылка.АР_НачислениеПени")
			//--ЭЛИАС 20140625

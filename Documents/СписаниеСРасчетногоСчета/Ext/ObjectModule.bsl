...
Процедура ЗаполнитьПоПоступлениюНаРасчетныйСчет()
	...
	Если ВидОперацииДокументаОснования = Перечисления.ВидыОперацийПоступлениеДенежныхСредств.ОплатаПокупателя Тогда
		...
		//++ЭЛИАС 20180814 
		АР_ОплатаАренды = ДокументОснование.АР_ОплатаАренды;
		...
		//++ЭЛИАС 20180814 
		СтруктураКурсаДокумента = АР_ПроцедурыНачисления.ПолучитьКурсВалюты(ДанныеОснования.ВалютаДокумента, Дата, ДоговорКонтрагента);
		//--ЭЛИАС 20180814
		КурсДокумента      = СтруктураКурсаДокумента.Курс;
		КратностьДокумента = СтруктураКурсаДокумента.Кратность;
		...
		//++ЭЛИАС 20180814 
		СтруктураКурсаОснования = АР_ПроцедурыНачисления.ПолучитьКурсВалюты(ДанныеОснования.ВалютаДокумента, ДанныеОснования.Дата, ДоговорКонтрагента);
		//--ЭЛИАС 20180814

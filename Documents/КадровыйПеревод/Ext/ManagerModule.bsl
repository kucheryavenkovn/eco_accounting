...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	НомерПриказа = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Данные.Ссылка, "НомерПриказа");
	Представление = СтрШаблон(НСтр("ru = 'Кадровый перевод %1 от %2'"), НомерПриказа, Формат(Данные.Дата, "ДЛФ=D"));

...
Процедура ЗаполнитьПоПервичномуБольничномуЛисту(НомерИлиСсылкаПервичногоБольничного) Экспорт
	
	ДанныеПервичногоБольничногоЛиста = УчетПособийСоциальногоСтрахования.ДанныеБольничногоЛиста(НомерИлиСсылкаПервичногоБольничного);

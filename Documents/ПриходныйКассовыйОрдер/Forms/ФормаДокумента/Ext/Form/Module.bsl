...
Процедура ЗаполнитьПоСчетам(Команда)
	...
	Если Объект.РасшифровкаПлатежа.Количество() > 0 Тогда
		Оповещение = Новый ОписаниеОповещения("ВопросОбОчисткеТабЧасти", ЭтотОбъект);
...
//++ЭЛИАС 20140625  
&НаКлиенте
Процедура ВопросОбОчисткеТабЧасти(РезультатВопроса, ДополнительныеПараметры) Экспорт

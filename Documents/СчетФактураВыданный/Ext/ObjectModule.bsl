...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты") или ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.РеализацияТоваровУслуг") Тогда 
...
Процедура УстановитьСтатусДокумента()
	...
	Для Каждого СтрокаТЧ Из ДокументыОснования Цикл
		Если ТипЗнч(СтрокаТЧ.ДокументОснование) = Тип("ДокументСсылка.РеализацияТоваровУслуг")
			...
			//++ЭЛИАС 20190828 
		ИначеЕсли (ТипЗнч(СтрокаТЧ.ДокументОснование) = Тип("ДокументСсылка.АР_НачислениеАренднойПлаты")
			ИЛИ ТипЗнч(СтрокаТЧ.ДокументОснование) = Тип("ДокументСсылка.АР_НачислениеПени"))
			И СтрокаТЧ.ДокументОснование <> Документы.АР_НачислениеАренднойПлаты.ПустаяСсылка() 
			И СтрокаТЧ.ДокументОснование <> Документы.АР_НачислениеПени.ПустаяСсылка() 
			И СтрокаТЧ.ДокументОснование <> ДокументСУстановленнымСтатусом Тогда 
			ДокументыОснованияДляУстановкиСтатуса.Добавить(СтрокаТЧ.ДокументОснование);
			//--ЭЛИАС 20190828
		КонецЕсли;

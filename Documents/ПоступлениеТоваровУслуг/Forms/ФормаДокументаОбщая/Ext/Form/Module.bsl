...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтеграцияС1СДокументооборотом") Тогда
		МодульИнтеграцияС1СДокументооборот = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1СДокументооборот");
		МодульИнтеграцияС1СДокументооборот.ПередЗаписьюНаСервере(ЭтаФорма, ТекущийОбъект, ПараметрыЗаписи);
	КонецЕсли;
	// Конец ИнтеграцияС1СДокументооборотом
...
Процедура ТоварыКоличествоПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииКоличество(ЭтаФорма, "Товары",, ПрименяютсяСтавки4и2);
...
Процедура ТоварыЦенаПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииЦена(ЭтаФорма, "Товары",, ПрименяютсяСтавки4и2);
...
Процедура ТоварыСуммаПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииСумма(ЭтаФорма, "Товары",, ПрименяютсяСтавки4и2);
...
Процедура ТоварыСтавкаНДСПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииСтавкаНДС(ЭтаФорма, "Товары", ПрименяютсяСтавки4и2);
...
Процедура ТоварыСуммаНДСПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииСуммаНДС(ЭтаФорма, "Товары");
...
Процедура УслугиКоличествоПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииКоличество(ЭтаФорма, "Услуги", 1, ПрименяютсяСтавки4и2);
...
Процедура УслугиЦенаПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииЦена(ЭтаФорма, "Услуги", ПрименяютсяСтавки4и2, 1);
...
Процедура УслугиСуммаПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииСумма(ЭтаФорма, "Услуги", ПрименяютсяСтавки4и2, 1);
...
Процедура АгентскиеУслугиКоличествоПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииКоличество(ЭтаФорма, "АгентскиеУслуги", ,1);
...
Процедура АгентскиеУслугиЦенаПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииЦена(ЭтаФорма, "АгентскиеУслуги", ,1);
...
Процедура АгентскиеУслугиСуммаПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииСумма(ЭтаФорма, "АгентскиеУслуги", ,1);
...
Процедура АгентскиеУслугиСтавкаНДСПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииСтавкаНДС(ЭтаФорма, "АгентскиеУслуги");
...
Процедура АгентскиеУслугиСуммаНДСПриИзменении(Элемент)
	...
	ПоступлениеТоваровУслугФормыКлиентСервер.ПриИзмененииСуммаНДС(ЭтаФорма, "АгентскиеУслуги");
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ОригиналСчетаФактуры.Видимость = Форма.ТребуетсяСчетФактура И НЕ Объект.НДСНеВыделять;
...
Процедура Подключаемый_ВыполнитьКомандуИнтеграции(Команда)
	...
	МодульИнтеграцияС1СДокументооборотКлиент.ВыполнитьПодключаемуюКомандуИнтеграции(Команда, ЭтаФорма, Объект);

...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ОтразитьВТрудовойКнижке Тогда
		...
		Если ЗначениеЗаполнено(ВидЗаявленияОВыбореСпособаВеденияТрудовойКнижки)
			И Не ЗначениеЗаполнено(ДатаЗаявленияОВыбореСпособаВеденияТрудовойКнижки) Тогда
		...
		ИначеЕсли Не ЗначениеЗаполнено(ВидЗаявленияОВыбореСпособаВеденияТрудовойКнижки)

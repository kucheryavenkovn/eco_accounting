...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если не Отказ Тогда 
		...
		Для Каждого ТекСтрокаТовары Из Товары Цикл
			Если ТекСтрокаТовары.Событие = Перечисления.СобытиеПеремещения.Ремонт Тогда 
			...
			Движение.СубконтоКт[ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ПрочиеДоходыИРасходы] = Справочники.ПрочиеДоходыИРасходы.ПрочиеВнереализационныеДоходыРасходы;
			Движение.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Номенклатура] = ТекСтрокаТовары.Номенклатура;
			Движение.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Склады] = Справочники.Склады.НайтиПоКоду("000000065");
			ИначеЕсли  ТекСтрокаТовары.Событие = Перечисления.СобытиеПеремещения.Металлолом Тогда 

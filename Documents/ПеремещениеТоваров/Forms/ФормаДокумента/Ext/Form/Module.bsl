...
Функция ПолучитьДанныеТоварыНоменклатураПриИзменении(Знач Контекст, Знач ДанныеСтроки, Знач СчетаУчетаКЗаполнению)
	...
	Результат.Вставить("Событие", Перечисления.СобытиеПеремещения.Списание); //Кучерявенко
...
//patimka
&НаСервере
Функция ВернутьСписание()
	Возврат Перечисления.СобытиеПеремещения.Списание;
КонецФункции

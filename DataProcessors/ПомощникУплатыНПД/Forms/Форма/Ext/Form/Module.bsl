...
Процедура Подключаемый_ПолучитьРезультатВыполненияВФонеСостояниеЛицевогоСчета()
	...
	НачатьПолучениеРезультатаВыполненияВФоне(ЗапросыОНачислениях().СостояниеЛицевогоСчета);
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидКнопкиПоУмолчанию(Форма, Элемент, ЭтоКнопкаПоУмолчанию)

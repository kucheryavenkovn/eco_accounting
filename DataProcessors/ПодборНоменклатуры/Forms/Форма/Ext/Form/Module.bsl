...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПомеченныеНаУдаление.СкрытьПомеченныеНаУдаление(ЭтотОбъект, "ИерархияНоменклатуры");
	ПомеченныеНаУдаление.СкрытьПомеченныеНаУдаление(ЭтотОбъект, "СписокНоменклатуры");

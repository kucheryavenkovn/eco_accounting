...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ФоновоеЗаданиеПолучениеОписанияТарифов = ДлительныеОперации.ВыполнитьВФоне("Обработки.ОплатаСервисаБП.ПолучитьОписаниеТарифовВФоне",
...
Процедура ПолеHTMLДокументаПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	...
	Если ДанныеСобытия.href <> Неопределено Тогда
		...
		Если ОткрыватьФормуОплаты Тогда
			...
			ОткрытьФорму("Обработка.ОплатаСервисаБП.Форма.Оплата", ПараметрыФормы, ВладелецФормы,

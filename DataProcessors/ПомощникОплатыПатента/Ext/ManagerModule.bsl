...
Функция СведенияОПатенте(Патент)
	...
	|	СправочникПатенты.ПотенциальноВозможныйГодовойДоход КАК ПотенциальноВозможныйГодовойДоход,
	...
	|	СправочникПатенты.СуммаОсвобожденияОтНалога КАК СуммаОсвобожденияОтНалога
	|ИЗ

...
Процедура РасчетСуммыКУплате()
	...
	СуммаНалога  = ТекущийПлатеж + ПредыдущийПлатеж - Уплачено;
	СуммаКУплате = СуммаНалога - НалоговыйВычетТекущийПлатеж;
...
Процедура ОформитьОсвобождениеОтНалога(Форма)
	...
	Элементы.ОсвобождениеОтНалога.Видимость = Форма.ПрименяетсяОсвобождениеОтНалога;
	Элементы.НалогПоПатентуКУплате.Видимость = Форма.ПрименяетсяОсвобождениеОтНалога;

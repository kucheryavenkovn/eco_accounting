...
Процедура ЗаполнитьПоясненияКРасчетуОбъектДоходы(ТаблицаЭтапы, Показатели)
	...
	Если Показатели.ПлательщикТорговогоСбора Тогда // Налоговый вычет с подчиненными показателями.
		...
		ЗначениеЭтапа = Новый ФорматированнаяСтрока(УменьшениеНалогаФакт, , , ,
			НавигационнаяСсылкаРасходыУменьшающиеНалог(ЭтоИнтерфейсИнтеграцииСБанком));
...
Функция НавигационнаяСсылкаРасходыУменьшающиеНалог(ЭтоИнтерфейсИнтеграцииСБанком)
	
	Если ЭтоИнтерфейсИнтеграцииСБанком Тогда
		
		Возврат ""; // В интеграции с банком расшифровка уменьшения налога не предусмотрена.
		
	Иначе
		
		Возврат "РасшифровкаУменьшенияНалога";

...
Процедура ЗаполнитьОписаниеРазделаЗапасы(ОписаниеФункциональности)
	...
	Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ВедетсяУчетПоПутевымЛистам");
	Функциональность.ДоступнаВПростомИнтерфейсе = Истина;
...
Процедура ЗаполнитьОписаниеРазделаТорговля(ОписаниеФункциональности)
	...
	Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ИспользоватьДоставкуТранспортнойКомпанией");
	Функциональность.ДоступнаВПростомИнтерфейсе = Истина;
	ДобавитьРодителя(Функциональность, "ИспользоватьДокументыРеализации");
	
	Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ИспользоватьОбменСИнтернетМагазином");
	Функциональность.ДоступнаВПростомИнтерфейсе = Истина;
	ДобавитьРодителя(Функциональность, "ИспользоватьДокументыРеализации");
...
Процедура ЗаполнитьОписаниеРазделаОбязательнаяМаркировка(ОписаниеФункциональности)
	...
	Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ИспользоватьПодконтрольныеТоварыККТ");
	Функциональность.ДоступнаВПростомИнтерфейсе = Истина;
...
Процедура ЗаполнитьОписаниеРазделаЗарплатаКадры(ОписаниеФункциональности, ИмяРаздела = Неопределено)
	...
	Если РезультатЗапросаЮридическиеЛица().Пустой() Тогда
		...
		Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ПоддержкаСовместительства");
		Функциональность.Доступна = НЕ ПолучитьФункциональнуюОпцию("УчетЗарплатыИКадровВоВнешнейПрограмме");
		Функциональность.ДоступнаВПростомИнтерфейсе  = Истина;
		ДобавитьРодителя(Функциональность, "ВедетсяУчетЗарплатыКадров");
		
		Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ИспользоватьНачисленияПоДоговорам");
		Функциональность.Доступна = НЕ ПолучитьФункциональнуюОпцию("УчетЗарплатыИКадровВоВнешнейПрограмме");
		Функциональность.ДоступнаВПростомИнтерфейсе  = Истина;
		ДобавитьРодителя(Функциональность, "ВедетсяУчетЗарплатыКадров");

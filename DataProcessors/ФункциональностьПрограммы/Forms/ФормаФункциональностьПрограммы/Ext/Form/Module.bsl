...
Процедура ОбработатьНажатиеОшибки(Элемент, ИмяЗаголовка)
	...
	ИначеЕсли ИмяЭлемента = "ИспользоватьДоставкуТранспортнойКомпанией" Тогда
		ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте("ИспользоватьДоставкуТранспортнойКомпанией");
	...
	ИначеЕсли ИмяЭлемента = "ВедетсяУчетПоПутевымЛистам" Тогда
		Если ПоказыватьСинхронизациюДляОпций И ИспользуетсяСинхронизацияДанных() Тогда
			ОткрытьФормуОбъекта("Обработка.ФункциональностьПрограммы.Форма.ФормаИспользуетсяСинхронизацияДанных");
		Иначе
			ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте("ВедетсяУчетПоПутевымЛистам");
		КонецЕсли;
	...
	ИначеЕсли ИмяЭлемента = "ИспользоватьПодконтрольныеТоварыККТ" Тогда
		ЗначениеОтбора = Новый Структура(
			...
			Истина);
		ПараметрыФормы = Новый Структура("Отбор", ЗначениеОтбора);
		ОткрытьФормуОбъекта("Справочник.Номенклатура.Форма.ФормаСписка", ПараметрыФормы);
	...
	ИначеЕсли ИмяЭлемента = "ПоддержкаСовместительства" Тогда
		ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте("ПоддержкаСовместительства");
	ИначеЕсли ИмяЭлемента = "ИспользоватьНачисленияПоДоговорам" Тогда
		ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте("ИспользоватьНачисленияПоДоговорам");
...
Процедура СформироватьКлючевыеСловаЭлементовФункциональности()
	...
	Для каждого ЭлементФункциональности Из ОписаниеФункциональности Цикл
		...
		Раздел = Элементы["Группа" + ЭлементФункциональности.Раздел];

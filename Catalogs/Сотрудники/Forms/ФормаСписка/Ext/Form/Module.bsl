...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.КоманднаяПанельФормыВыбора.Видимость = Параметры.РежимВыбора;
	...
	Иначе
		...
		ПараметрыРазмещения.КоманднаяПанель = Элементы.КоманднаяПанельФормыЛевая;
	...
	Иначе
		Элементы.ОтборРолиСотрудников.Видимость = Ложь;
	КонецЕсли;

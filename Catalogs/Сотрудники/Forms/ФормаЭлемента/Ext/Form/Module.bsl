...
Процедура ОформитьПриемНаРаботуУпрощенный(Команда)
	...
	ПараметрыОткрытия = Новый Структура("ТекущаяОрганизация, ТекущееПодразделение,
		|ТекущийВидЗанятости, ТекущийСпособРасчетаАванса, ТекущийАванс,
...
Процедура ПросклонятьФИО()
	...
	Если ФизическоеЛицо.Пол = ПредопределенноеЗначение("Перечисление.ПолФизическогоЛица.Мужской") Тогда
		ПараметрыСклонения.Пол = 1;
	ИначеЕсли ФизическоеЛицо.Пол = ПредопределенноеЗначение("Перечисление.ПолФизическогоЛица.Женский") Тогда
...
Процедура УправлениеФормой(Форма)
	...
	РассчитыватьЗарплатуНебольшихОрганизаций    = Форма.РассчитыватьЗарплатуНебольшихОрганизаций;
...
Процедура ОписаниеВспомогательныхРеквизитовПриЧтенииНаСервере()
	...
	РассчитыватьЗарплатуНебольшихОрганизаций    = ПолучитьФункциональнуюОпцию("РасчетЗарплатыДляНебольшихОрганизаций");

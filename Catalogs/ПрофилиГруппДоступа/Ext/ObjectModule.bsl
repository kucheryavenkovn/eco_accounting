...
Процедура ПередЗаписью(Отказ)
	...
	//++ЭЛИАС 20120711 Добавим вспомогательную роль
	Идентификатор = Справочники.ИдентификаторыОбъектовМетаданных.НайтиПоРеквизиту("Имя", "АР_ДополнительныеПраваНаЧтениеДанныхАренды");
	Если Роли.Найти(Идентификатор, "Роль") = Неопределено Тогда 
		НоваяРоль = Роли.Добавить();
		НоваяРоль.Роль = Идентификатор;
	КонецЕсли;
	//--ЭЛИАС 20120711

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ГодПлатежа = Макс(ГодАктуальностиКлассификатора, Год(ОбщегоНазначения.ТекущаяДатаПользователя()));
	КонецЕсли;
...
Процедура СоздатьСоответствиеВидаИПодвидаДоходаДляСтраховыхВзносов()
	...
	ВидИПодвидДоходаИсключения.Вставить("ВД1160301001", ПодвидыДохода);

	...
	Иначе // Создание по реквизитам
		...
		Если ЭтоИндивидуальныйПредприниматель Тогда
			...
			Если ЗначениеЗаполнено(Реквизиты.Фамилия)
				...
				Организация.НаименованиеСокращенное = ОрганизацииФормыКлиентСервер.СокращенноеНаименованиеИндивидуальногоПредпринимателя(
														Реквизиты.Фамилия, Реквизиты.Имя, Реквизиты.Отчество);
				Организация.НаименованиеПолное      = ОрганизацииФормыКлиентСервер.ПолноеНаименованиеИндивидуальногоПредпринимателя(
														Реквизиты.Фамилия, Реквизиты.Имя, Реквизиты.Отчество);
				Организация.Наименование            = ОрганизацииФормыКлиентСервер.НаименованиеИндивидуальногоПредпринимателя(
														Реквизиты.Фамилия, Реквизиты.Имя, Реквизиты.Отчество);
			КонецЕсли;

...
Функция ПатентыОрганизацииУплачиваемыеЗаПериод(Организация, ДатаНачала, ДатаОкончания) Экспорт
	...
	|	Патенты.ПотенциальноВозможныйГодовойДоход КАК ПотенциальноВозможныйГодовойДоход
	|ИЗ
	|	Справочник.Патенты КАК Патенты
	|ГДЕ
	|	Патенты.Владелец = &Организация
	|	И НЕ Патенты.ПометкаУдаления
	|	И (Патенты.ДатаПервогоПлатежа МЕЖДУ &ДатаНачала И &ДатаОкончания
	|			ИЛИ Патенты.ДатаВторогоПлатежа МЕЖДУ &ДатаНачала И &ДатаОкончания)";

...
Функция НовыйОписаниеТребования()
	...
	Требования.Колонки.Добавить("ОснованиеПродленияСроковНалоговОтчетов",
	                                                             ОписаниеРеквизитов.ОснованиеПродленияСроковНалоговОтчетов.Тип); // Основание для продления сроков выполнения действия, см. Перечисления.ОснованияПродленияСроковНалоговОтчетов

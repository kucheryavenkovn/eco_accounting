...
Функция ПорядокПредоставленияОтчетаУплатыНалогаЗаПериод(Организация, ВидНалогаПравила, Период, Действие = Неопределено, ПроверятьУсловияТолькоНаГраницахОбзора = Ложь) Экспорт
	...
	Расписание.Колонки.Добавить("ПеренестиНаРабочийДень", Новый ОписаниеТипов("Число"));
	ЗаполнитьРасписаниеПоНалогамИСборам(Расписание, ОтборПравил);
...
Процедура ЗаполнитьРасписаниеПоНалогамИСборам(Расписание, ОтборПравил, ОбновитьСписокОтчетов = Истина)
	...
	|	КОНЕЦ КАК СрокДней,
	|	Регламент.ОснованиеПродленияСроковНалоговОтчетов КАК ОснованиеПродленияСроковНалоговОтчетов,
	...
	Пока Выборка.Следующий() Цикл
		...
		Для Каждого НачалоПериода Из РелевантныеПериоды Цикл
			...
			ЗаполнитьЗначенияСвойств(СтрокаРасписания, ОписаниеДействия(Выборка, ПериодСобытия, ПараметрыПродленияСроков));
...
Процедура ЗаполнитьРасписаниеУплатыПатентов(Организация, Правила, Расписание)
	...
	Для каждого Правило Из Правила Цикл
		...
		Если ОснованияПродленияСроков.Найти(
			Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1аАбз4) <> Неопределено Тогда
...
Процедура ЗаписатьИзменения(Организация, Расписание, ТекущаяДата, ИзмененыЗаписи = Ложь)
	...
	|	МогутБытьУдалены.РегистрацияВНалоговомОргане
	|ИЗ
...
Функция ОписаниеДействия(Правило, ПериодСобытия, ПараметрыПереносаСроков)
	...
	Если ЗначениеЗаполнено(Правило.ОснованиеПродленияСроковНалоговОтчетов) 
		И ОснованияПродления.Найти(Правило.ОснованиеПродленияСроковНалоговОтчетов) <> Неопределено Тогда
		
		СдвинутьСрокВыполнения(Срок, ПериодСобытия, Правило.ОснованиеПродленияСроковНалоговОтчетов);
...
Процедура СдвинутьСрокВыполнения(Срок, ПериодСобытия, ОснованиеПереносаСроковОтчетовНалогов)
	...
	Если ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1аАбз1 Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1аАбз2 Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1аАбз3 Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1аАбз5 Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1б Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1бИП Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП1в Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП3Абз1 Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.МерыУстойчивогоРазвитияП3Абз2 Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.Постановление212ПП_П2 Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.РазъясненияФСС Тогда
	...
	ИначеЕсли ОснованиеПереносаСроковОтчетовНалогов = 
		Перечисления.ОснованияПродленияСроковНалоговОтчетов.РазъясненияМинюста Тогда

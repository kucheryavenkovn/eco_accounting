...
// Конструктор коллекции, описывающей период данных, записанных в регистр.
// Подробнее см. комментарий к ПериодРасчета
// 
// Возвращаемое значение:
//  Структура
//
...
// Определяет период данных, записанных в регистр, соответствующий дате начала периода отчета.
//
// Параметры:
//  НачалоПериода - Дата
//  КонецПериода  - Дата
...
// 
// Возвращаемое значение:
//  Структура - см. НовыйПериодДанных
//
...
// Определяет период данных, записанных в регистр, соответствующий дате конца периода отчета.
//
// Параметры:
//  НачалоПериода - Дата
//  КонецПериода  - Дата
...
// Определяет, содержатся ли в регистре на конкретный период по конкретной организации данные о балансовых показателях
// (сумме бухгалтерского или налогового учета).
// Эти данные записываются, начиная с версии 3.0.75
//
// Параметры:
//  ПериодДанных - Структура - см. НовыйПериодДанных
//  Организация  - СправочникСсылка.Организации
// 
// Возвращаемое значение:
//  Булево - Истина, если данные есть.
//

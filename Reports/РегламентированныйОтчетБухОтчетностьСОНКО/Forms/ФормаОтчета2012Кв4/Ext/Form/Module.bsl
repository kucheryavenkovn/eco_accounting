...
Процедура ВывестиНаПечатьКНД0710097(ПараметрыПечати)
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2013-01-01' Тогда
		...
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2013Кв1_КНД0710097_1");
	...
	Иначе
		...
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2012Кв1_КНД0710097_1");
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2013-01-01' Тогда
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2013Кв1_КНД0710097_2");
	Иначе
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2012Кв1_КНД0710097_2");
	КонецЕсли;

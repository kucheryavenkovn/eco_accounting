...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Попытка
		СчетаУчетаРасчетов.СчетаСДокументомРасчетов.Удалить(СчетаУчетаРасчетов.СчетаСДокументомРасчетов.Найти(ПланыСчетов.Хозрасчетный.РезервыПоСомнительнымДолгам));
		СчетаУчетаРасчетов.СчетаСДокументомРасчетов.Очистить();
		СчетаУчетаРасчетов.СчетаСДокументомРасчетов.Добавить(ПланыСчетов.Хозрасчетный.РасчетыСПокупателями);
		СчетаУчетаРасчетов.СчетаСДокументомРасчетов.Добавить(ПланыСчетов.Хозрасчетный.РасчетыПоАвансамПолученным);
		
		СчетаУчетаРасчетов.СчетаБезДокументаРасчетов.СчетаСДокументомРасчетов.Удалить(СчетаУчетаРасчетов.СчетаСДокументомРасчетов.Найти(ПланыСчетов.Хозрасчетный.РезервыПоСомнительнымДолгам));
		СчетаУчетаРасчетов.СчетаБезДокументаРасчетов.СчетаСДокументомРасчетов.Очистить();
		СчетаУчетаРасчетов.СчетаБезДокументаРасчетов.СчетаСДокументомРасчетов.Добавить(ПланыСчетов.Хозрасчетный.РасчетыСПокупателями);
		СчетаУчетаРасчетов.СчетаБезДокументаРасчетов.СчетаСДокументомРасчетов.Добавить(ПланыСчетов.Хозрасчетный.РасчетыПоАвансамПолученным);
...
Функция ПолучитьТекстЗапроса(КоличествоИнтервалов)
	...
	|";
	Для Индекс = 1 По КоличествоИнтервалов+1 Цикл
		ТекстПоля = "	ОстаткиПоПериодам.ОстатокДолга" + (Индекс - 1) + "		КАК	ОстатокПериода" + Индекс + ",";
		ПолныйТекстЗапроса = ПолныйТекстЗапроса + Символы.ПС + ТекстПоля + Символы.ПС;
	КонецЦикла;

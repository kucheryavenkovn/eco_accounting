...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	ЦветФонаЗначение = ?(ОтклАвтоРасчетЗначение, Новый Цвет(230, 240, 220), Новый Цвет(192, 220, 192));
	...
	Для Гр = 3 По 13 Цикл
		...
		мФормаОтчета.Области["П0000101009" + ГрСтр].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101009" + ГрСтр].Защита = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101005" + ГрСтр].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101005" + ГрСтр].Защита = Не ОтклАвтоРасчетЗначение;
		
		мФормаОтчета.Области["П0000101001" + ГрСтр].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0000101001" + ГрСтр].Защита = Не ОтклАвтоРасчетЗначение;
	КонецЦикла;
	
	Для Гр = 3 По 4 Цикл
		мФормаОтчета.Области["П00004010380" + Гр].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П00004010380" + Гр].Защита = Не ОтклАвтоРасчетЗначение;
	КонецЦикла;

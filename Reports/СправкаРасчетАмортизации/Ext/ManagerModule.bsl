...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Для Каждого Способ Из МассивСпособов Цикл
		...
		Группировка         = БухгалтерскиеОтчеты.НайтиПоИмени(Таблица.Строки,"Группировка"         + Способ + СтрокаГруппировки);
		ГруппировкаАмГруппа = БухгалтерскиеОтчеты.НайтиПоИмени(Таблица.Строки,"ГруппировкаАмГруппа" + Способ + СтрокаГруппировки);
		ГруппировкаОбъект   = БухгалтерскиеОтчеты.НайтиПоИмени(Таблица.Строки,"ГруппировкаОбъект"   + Способ + СтрокаГруппировки);
		ГруппировкаПериод   = БухгалтерскиеОтчеты.НайтиПоИмени(Таблица.Строки,"ГруппировкаПериод"   + Способ + СтрокаГруппировки);

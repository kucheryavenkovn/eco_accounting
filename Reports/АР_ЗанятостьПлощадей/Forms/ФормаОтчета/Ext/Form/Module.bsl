...
Функция  ПолучитьДанныеПланировок()
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АР_СтатусыОбъектовАренды.СрезПоследних(&ТекущаяДата, Услуга.АР_УслугаАренды ИЛИ Услуга = Значение(Справочник.Номенклатура.ПустаяСсылка)) КАК АР_СтатусыОбъектовАренды
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АР_ОбъектыПодлежащиеСдачеВАренду.СрезПоследних(&ТекущаяДата, ) КАК ОбъектыПодлежащиеСдачеВАренду

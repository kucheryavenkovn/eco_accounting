...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	ТаблицаРасчетЕНВД = БухгалтерскиеОтчеты.НайтиПоИмени(КомпоновщикНастроек.Настройки.Структура, "РасчетЕНВД");
	...
	Если ТаблицаРасчетЕНВД <> Неопределено Тогда
		...
		ГруппировкаВидДеятельности = БухгалтерскиеОтчеты.НайтиПоИмени(ТаблицаРасчетЕНВД.Строки, ИмяГруппировки);
	...
	ГруппировкаРасходНаККТ = БухгалтерскиеОтчеты.НайтиПоИмени(КомпоновщикНастроек.Настройки.Структура, "РасходНаККТ");
...
Процедура ОбработатьТаблицуМакета(Таблица, ИменаГруппировок)
	...
	Если ТипЗнч(Таблица) = Тип("ТаблицаМакетаКомпоновкиДанных") Тогда
	...
	ИначеЕсли ТипЗнч(Таблица) = Тип("ГруппировкаМакетаКомпоновкиДанных") Тогда
